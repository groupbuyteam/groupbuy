...
import net.groupbuy.FileInfo.FileType;
import net.groupbuy.Setting.AccountLockType;
import net.groupbuy.Setting.CaptchaType;
import net.groupbuy.Setting.ConsultationAuthority;
import net.groupbuy.Setting.ReviewAuthority;
import net.groupbuy.Setting.RoundType;
import net.groupbuy.Setting.StockAllocationTime;
import net.groupbuy.Setting.WatermarkPosition;
import net.groupbuy.service.CacheService;
import net.groupbuy.service.FileService;
import net.groupbuy.service.MailService;
